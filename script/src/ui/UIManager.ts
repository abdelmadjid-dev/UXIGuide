    ...
    private renderConsentModal() {
        ...
        const content = [
            {
                ...
                description: "Allows the AI to see the page structure for better guidance.",
            },
            {
                icon: "🪄",
                title: "Interactive Assistance",
                description: "Enables highlighting and animations to guide your workflow.",
            }
        ]
        ...
        this.modalOverlay.innerHTML = `
            <div class="uxiguide-modal">
                <h2 style="color: ${this.themeConfig?.modalTitleColor || "#141414"}">Permissions Required</h2>
                <p style="color: ${this.themeConfig?.modalBodyColor || "#666666"}">This script needs the following permissions to provide assistance.</p>
        ...
        `;
        this.modalOverlay.style.backgroundColor = this.themeConfig?.modalColor || "#FFFFFF";
